...
/* clang-format off */
#if 1 //#if 0 /*Set it to "1" to enable the content*/
...
//#  define EVDEV_NAME   "/dev/i2c-2"        /*You can use the "evtest" Linux tool to get the list of devices and test them*/
